...
Provides: java-virtual-machine, java-runtime, java2-runtime, java${j2se_release}-runtime, java-browser-plugin, java-compiler, java2-compiler, java-runtime-headless, java2-runtime-headless, java${j2se_release}-runtime-headless, java-sdk, java2-sdk, j2sdk$j2se_release, j2re${j2se_release}
