...
Provides: java-virtual-machine, java-runtime, java2-runtime, java${j2se_release}-runtime, java-runtime-headless, java2-runtime-headless, java${j2se_release}-runtime-headless, java-browser-plugin, j2re${j2se_release}
